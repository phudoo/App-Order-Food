...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); // Laravel Bootstrap dependencies
...
if (!token) {
  window.location.href = '/login'; // Chuyển hướng tới trang đăng nhập nếu không có token
}
